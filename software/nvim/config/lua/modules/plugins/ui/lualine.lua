return function()
    ...
    local function get_cwd()
        ...
        local is_windows = require("env").is_windows
        if not is_windows then
            local home = require("env").home
    ...
    local winbar_bg = require("modules.utils.color").hl_to_rgb("StatusLine", true, colors.mantle)
    for _, hlGroup in pairs(require("lspsaga.lspkind").get_kind_group()) do
        require("modules.utils.color").extend_hl(hlGroup, { bg = winbar_bg })
    end
end
